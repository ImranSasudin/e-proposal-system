    		...
    		<div id="cover-caption">
       			 <div id="container" class="container">
          			  <div class="row text-black">
							...
							<div class="info-form">
							<form action = "updateProposal.php" method = "post" enctype="multipart/form-data" class="form-inlin justify-content-center">
								 <div class="form-group">
                          			  	<br/>
                          			  	<h3 class="text-left ">Program Name:</h3>
										<input type = "text" name = "name" value="<?php echo $rows['prog_name']; ?>" class="form-control border border-light"/ required>
								</div>		
								<div class="form-group">
                          			  	<br/>
                          			  	<h3 class="text-left"> New Proposal File (if necessary): </h3>
										<input type ="file" name = "proposalFile" class="form-control border border-light" >
								</div>		
