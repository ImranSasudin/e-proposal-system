...
$sql = "select semester, count(prop_id) from proposal group by semester";
       			 ...
       			 <div id="container" class="container">
          			  <div class="row text-black">
               			 <div class="col-lg-8 offset-sm-2 text-center">
								<h1>Proposal By Semester</h1><br/><br/>
								 <div class="info-form">
										...
										<table id = "dtBasicExample" class="table table-striped table-bordered" >
											...
											<tbody>
												...
												<tr>
													...
													<td style="color: blue;"><a href="listProposalBySemester.php?semester=<?php echo $rows['semester'];?>"><?php echo $rows['semester'];?></a></td>
