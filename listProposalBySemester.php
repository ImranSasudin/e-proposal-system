...
$sql = "SELECT * FROM proposal where Semester = '".$semester."'";
    		...
    		<div id="cover-caption">
       			 <div id="container" class="container">
          			  <div class="row text-black">
							...
							<h1>Proposal List By Semester</h1><br/><br/>
								 <div class="info-form">
										...
										<table id = "dtBasicExample" class="table table-striped table-bordered">
											...
											<tr>
												...
												<td><a href = "verifyProposal.php?id=<?php echo $rows['prop_id']; ?>&page=SemesterProposal&semester=<?php echo $semester ?>"><i class="fas fa-edit"></i></a></td>
												<td><a onclick="return confirm('Are you sure you want to delete this proposal?');" href = "deleteProposal.php?id=<?php echo $rows['prop_id']; ?>&page=SemesterProposal&semester=<?php echo $semester ?>"><i class="fas fa-trash-alt"></i></a></td>
