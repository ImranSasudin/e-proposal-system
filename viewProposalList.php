								 ...
								 <div class="info-form">
										...
										<table id = "dtBasicExample" class="table table-striped table-bordered">
											...
											<tr>
												...
												<td><a href = "verifyProposal.php?id=<?php echo $rows['prop_id']; ?>&page=allProposal"><i class="fas fa-edit"></i></a></td>
												<td><a onclick="return confirm('Are you sure you want to delete this proposal?');" href = "deleteProposal.php?id=<?php echo $rows['prop_id']; ?>&page=allProposal"><i class="fas fa-trash-alt"></i></a></td>
